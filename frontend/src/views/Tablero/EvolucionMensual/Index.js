    ...
    data_ = [
      {
        ...
        data: [
          ...
          {
            x: "Febrero",
            y: month >= 1 ? data[0].mto_devenga_02 : null,
          },
          {
            x: "Marzo",
            y: month >= 2 ? data[0].mto_devenga_03 : null,
          },
          {
            x: "Abril",
            y: month >= 3 ? data[0].mto_devenga_04 : null,
          },
          {
            x: "Mayo",
            y: month >= 4 ? data[0].mto_devenga_05 : null,
          },
          {
            x: "Junio",
            y: month >= 5 ? data[0].mto_devenga_06 : null,
          },
          {
            x: "Julio",
            y: month >= 6 ? data[0].mto_devenga_07 : null,
          },
          {
            x: "Agosto",
            y: month >= 7 ? data[0].mto_devenga_08 : null,
          },
          {
            x: "Setiembre",
            y: month >= 8 ? data[0].mto_devenga_09 : null,
          },
          {
            x: "Octubre",
            y: month >= 9 ? data[0].mto_devenga_10 : null,
          },
          {
            x: "Noviembre",
            y: month >= 10 ? data[0].mto_devenga_11 : null,
          },
          {
            x: "Diciembre",
            y: month >= 11 ? data[0].mto_devenga_12 : null,
          },
        ],
      },
    ];
